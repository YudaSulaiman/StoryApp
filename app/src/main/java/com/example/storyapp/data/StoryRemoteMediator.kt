...
class StoryRemoteMediator(
    ...
    override suspend fun load(
        ...
        wrapEspressoIdlingResource {
            try {
                val data = apiService.getAllStories(token, page, state.config.pageSize, 0)
                val responseData = data.listStory
                Log.i("RESULT(TRY)", responseData.toString())
                ...
                Log.i("RESULT(CATCH)", exception.toString())
